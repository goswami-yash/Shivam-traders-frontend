...
export default function PartnerPage() {
  ...
  const getPartnerList = async () => {
    try {
      const data = await getAdminList("PartnerList", pagination.currentPage, pagination.pageSize,filters);
      setData(data.result || []);
  ...
  return (
    ...
    <TableBody
      tableConfig={TableContent.PartnerList}
      data={data}
      type='Partner'
      refreshData={getPartnerList}
